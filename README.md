...
**Status:** 40 verified core sites and a validated schema; awaiting the CP2 checkpoint (milestone M2). See [CHECKPOINTS.md](CHECKPOINTS.md) and [docs/PROGRESS.md](docs/PROGRESS.md).
