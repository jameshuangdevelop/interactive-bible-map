...
| [M2-01](M2-01-schema-validation.md) | Data schema, validation and CI | gis-engineer | `feat/m2-schema-validation` | Done, awaiting CP2 |
| [M2-02](M2-02-core-sites-batch-1.md) | Core sites, batch 1 (20 sites + 2 regions) | research-lead → media-curator → fact-checker | `data/m2-batch-1` | Verified, awaiting CP2 |
| [M2-03](M2-03-core-sites-batch-2.md) | Core sites, batch 2 (20 sites + 1 region) | research-lead → media-curator → fact-checker | `data/m2-batch-2` | Verified, awaiting CP2 |
