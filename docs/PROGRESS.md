...
| M1-01 | Source inventory with licenses | research-lead | `docs/m1-source-inventory` | In progress (subagent, ADR-0007) | — |
| M1-02 | Stack and hosting options with pricing | gis-engineer | `docs/m1-stack-options` | In progress (subagent, ADR-0007) | — |
