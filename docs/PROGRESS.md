...
**Current milestone:** M1 – Research & Options · **Status:** awaiting CP1 approval · **Budget used this month:** ~3,200 of 1,000,000 AI credits ([BUDGET.md](BUDGET.md))
...
| M1-04 | CP1 summary and stack ADRs | project-owner | `docs/cp1-summary` | Done, awaiting CP1 | — |
